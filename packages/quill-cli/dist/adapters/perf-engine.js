...
exports.runAutocannon = runAutocannon;
exports.runTinybench = runTinybench;
exports.runC8 = runC8;
exports.measureMemoryGrowth = measureMemoryGrowth;
exports.runFullPerfAnalysis = runFullPerfAnalysis;
// ============================================================
...
// ============================================================
async function runTinybench(benchmarks) {
...
// PART 3 — c8 (커버리지)
// ============================================================
async function runC8(command, rootPath) {
...
// ============================================================
async function measureMemoryGrowth(fn, iterations = 100) {
    const snapshots = [];
    ...
    const leakSuspected = (growthRateMBPerIter > 0.01 &&
        maxConsecutiveRise >= Math.floor(snapshots.length * 0.4)) || growth > 50;
...
// ============================================================
async function runFullPerfAnalysis(rootPath) {
    const results = [];
    // c8 coverage
    try {
