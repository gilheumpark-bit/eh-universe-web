...
exports.getLocalModelConfig = getLocalModelConfig;
exports.isLocalModelAvailable = isLocalModelAvailable;
exports.streamLocalChat = streamLocalChat;
exports.streamWithFallback = streamWithFallback;
...
function getLocalModelConfig() {
    const config = (0, config_1.loadMergedConfig)();
...
// ============================================================
async function streamLocalChat(opts) {
    const config = getLocalModelConfig();
    if (!config)
...
async function streamOllama(config, opts) {
...
async function streamLMStudio(config, opts) {
