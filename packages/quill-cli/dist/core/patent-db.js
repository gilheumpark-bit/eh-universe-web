...
exports.PATENT_PATTERNS = void 0;
exports.checkPatentPatterns = checkPatentPatterns;
exports.PATENT_PATTERNS = [
    {
...
function checkPatentPatterns(prompt) {
    const lower = prompt.toLowerCase();
    const warnings = [];
    const blocks = [];
    for (const pattern of exports.PATENT_PATTERNS) {
