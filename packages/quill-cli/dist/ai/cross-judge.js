...
exports.CROSS_JUDGE_SYSTEM_PROMPT = void 0;
exports.buildJudgePrompt = buildJudgePrompt;
exports.parseJudgeResult = parseJudgeResult;
// IDENTITY_SEAL: PART-1 | role=types | inputs=none | outputs=JudgeFinding,JudgeResult
// ============================================================
// PART 2 — Cross-Model Judge System Prompt
// ============================================================
exports.CROSS_JUDGE_SYSTEM_PROMPT = `You are an INDEPENDENT code judge. You receive code + static analysis findings.
...
// ============================================================
function buildJudgePrompt(code, findings) {
    const lines = [
        '=== GENERATED CODE ===',
        '```',
        code.slice(0, 6000),
