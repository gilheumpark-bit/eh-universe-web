...
exports.PRECISION_CHECKLIST = void 0;
exports.getChecklistBySeverity = getChecklistBySeverity;
exports.getChecklistByCategory = getChecklistByCategory;
exports.getChecklistStats = getChecklistStats;
exports.buildPrecisionReviewPrompt = buildPrecisionReviewPrompt;
exports.parsePrecisionResult = parsePrecisionResult;
exports.runPrecisionReview = runPrecisionReview;
// ============================================================
...
// ============================================================
exports.PRECISION_CHECKLIST = [...P0_CHECKS, ...P1_CHECKS, ...P2_CHECKS];
function getChecklistBySeverity(severity) {
    return exports.PRECISION_CHECKLIST.filter(c => c.severity === severity);
}
function getChecklistByCategory(category) {
    return exports.PRECISION_CHECKLIST.filter(c => c.category === category);
}
function getChecklistStats() {
    const categories = [...new Set(exports.PRECISION_CHECKLIST.map(c => c.category))];
    return {
        total: exports.PRECISION_CHECKLIST.length,
        p0: P0_CHECKS.length,
        p1: P1_CHECKS.length,
        p2: P2_CHECKS.length,
        categories,
...
// ============================================================
function buildPrecisionReviewPrompt(code, fileName, mode = 'full') {
    const checks = mode === 'quick' ? P0_CHECKS : exports.PRECISION_CHECKLIST;
    const lines = [
    ...
    for (const check of checks) {
        ...
        if (check.example)
            lines.push(`  Example: ${check.example}`);
    }
    lines.push('');
    lines.push('CODE:');
    lines.push('```');
...
function parsePrecisionResult(raw) {
    try {
        ...
        if (!Array.isArray(parsed))
            return [];
        return parsed.filter((f) => typeof f === 'object' && f !== null && 'id' in f && 'line' in f && 'message' in f);
    }
    catch {
        return [];
    }
...
// ============================================================
async function runPrecisionReview(code, fileName, mode = 'full') {
