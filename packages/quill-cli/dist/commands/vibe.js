...
exports.VIBE_TEMPLATES = void 0;
exports.runVibe = runVibe;
exports.detectVibeFromPrompt = detectVibeFromPrompt;
exports.buildStyleConstraints = buildStyleConstraints;
...
exports.VIBE_TEMPLATES = VIBE_TEMPLATES;
/**
...
function detectVibeFromPrompt(prompt) {
    ...
    let bestMatch = { template: VIBE_TEMPLATES.casual, score: 0 };
 ...
 */
function buildStyleConstraints(template) {
...
// ============================================================
function buildVibeSpecPrompt(template) {
