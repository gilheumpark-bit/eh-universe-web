...
exports.runBookmark = runBookmark;
const fs_1 = require("fs");
const path_1 = require("path");
const config_1 = require("../core/config");
const generate_1 = require("./generate");
function getDBPath() {
    return (0, path_1.join)((0, config_1.getGlobalConfigDir)(), 'bookmarks.json');
}
...
function searchBookmarks(db, query) {
    const results = [];
...
// ============================================================
async function runBookmark(action, args) {
    ...
    switch (action) {
        ...
        case 'run': {
            ...
            await (0, generate_1.runGenerate)(bookmark.prompt, {
                mode: opts.mode ?? 'full',
                structure: opts.structure ?? 'auto',
