...
export class ARIManager {
     ...
     */
    updateAfterCall(provider, success, latencyMs) {
    ...
    getBestProvider(candidates) {
        ...
        const sorted = [...candidates].sort((a, b) => this.getState(b).score - this.getState(a).score);
 ...
 */
export function routeToHealthiest(task, providers) {
