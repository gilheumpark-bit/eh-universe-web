...
describe('groupErrorsByFile', () => {
    it('groups errors by file path', () => {
        const errors = [
            { source: 'typescript', severity: 'error', file: 'a.ts', line: 1, column: 1, code: 'TS1', message: 'm1', raw: '' },
            { source: 'typescript', severity: 'error', file: 'a.ts', line: 2, column: 1, code: 'TS2', message: 'm2', raw: '' },
            { source: 'typescript', severity: 'error', file: 'b.ts', line: 1, column: 1, code: 'TS3', message: 'm3', raw: '' },
        ];
...
describe('errorSummary', () => {
    it('counts errors and warnings', () => {
        const errors = [
            { source: 'typescript', severity: 'error', file: '', line: 0, column: 0, code: '', message: '', raw: '' },
            { source: 'typescript', severity: 'warning', file: '', line: 0, column: 0, code: '', message: '', raw: '' },
            { source: 'typescript', severity: 'info', file: '', line: 0, column: 0, code: '', message: '', raw: '' },
        ];
