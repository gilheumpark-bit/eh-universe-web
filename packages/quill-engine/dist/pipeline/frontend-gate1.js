...
export function scan5States(code, fileName = 'unknown') {
    const findings = [];
...
export function scanDeadDOM(code, fileName = 'unknown') {
    const findings = [];
...
/** Gate 1 전체 실행 */
export function runFrontendGate1(code, fileName = 'unknown') {
    const findings = [
