...
function getOwningAsyncFunction(node) {
    ...
    if (fn.getKind() === SyntaxKind.FunctionDeclaration) {
        return fn.isAsync() ? fn : undefined;
    }
    if (fn.getKind() === SyntaxKind.MethodDeclaration) {
        return fn.hasModifier(SyntaxKind.AsyncKeyword) ? fn : undefined;
    }
