        ...
        {data.map((point, i) => {
          ...
          return (
            <div key={i} className="flex-1 relative h-full group cursor-default">
              <div
                className="absolute bottom-0 w-full rounded-t-sm bg-linear-to- from-accent-purple/60 to-accent-blue/40 transition-all duration-300"
                style={{ height: `${height}%` }}
              />
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
        <div className="absolute inset-0 bg-linear-to- from-accent-purple/[0.06] via-transparent to-transparent pointer-events-none" />
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 pointer-events-none">
        <div className="bg-linear-to- from-bg-primary via-bg-primary/90 to-transparent pt-12 pb-6">
