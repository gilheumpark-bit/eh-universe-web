...
### Q. 라이선스는 어떻게 되나요?
- **소프트웨어** (엔진·파이프라인·UI·CLI): **AGPL-3.0-or-later + Commercial** 이중 트랙 — 개인/학술/소스 공개 SaaS는 AGPL 무료, 클로즈드 SaaS·OEM·엔터프라이즈는 상업 라이선스
- **세계관 원본** (아카이브·코덱스·룰북): **CC-BY-NC-4.0** (소프트웨어와 분리)
- 이전 릴리스 (커밋 `414fe9ea` 및 그 이전): CC-BY-NC-4.0 영구 유지 (비취소 원칙)
- 상업 라이선스 / 세계관 상업 활용 문의: `gilheumpark@gmail.com`
