...
const RELATION_LABELS: Record<AppLanguage, Record<string, string>> = {
  ...
  JA: { stranger: '他人', formal: '敬語', colleague: '同僚', friend: '友人', intimate: '親密', hostile: '敵対' },
  ZH: { stranger: '陌生人', formal: '正式', colleague: '同事', friend: '朋友', intimate: '亲密', hostile: '敌对' },
};
...
const AGE_LABELS: Record<AppLanguage, Record<string, string>> = {
  ...
  JA: { teen: '10代', young_adult: '青年', adult: '成人', middle: '中年', elder: '高齢' },
  ZH: { teen: '青少年', young_adult: '青年', adult: '成人', middle: '中年', elder: '老年' },
};
...
const EXPLICIT_LABELS: Record<AppLanguage, Record<string, string>> = {
  ...
  JA: { none: 'なし', implied: '暗示', low: '低', medium: '中', high: '高' },
  ZH: { none: '无', implied: '暗示', low: '低', medium: '中', high: '高' },
};
...
const PROFANITY_LABELS: Record<AppLanguage, Record<string, string>> = {
  ...
  JA: { none: 'なし', mild: '軽度', strong: '強い' },
  ZH: { none: '无', mild: '轻微', strong: '强烈' },
};
