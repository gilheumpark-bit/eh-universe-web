      ...
      <section className="mb-10">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">
          {T({
            ...
            ja: "Loreguard で作成した作品の著作権は 100% 利用者に帰属",
            zh: "使用 Loreguard 创作的作品，著作权 100% 归用户所有",
          })}
        </p>
      </section>
        ...
        <div className="space-y-3 text-text-secondary text-sm leading-relaxed">
          <p>
            {T({
              ...
              ja: "韓国法2026: AI単独生成物に著作権はなし、人の創作的寄与がある部分には認められる可能性",
              zh: "韩国 2026 年规定: 纯 AI 生成作品不享有著作权，但含有人类创造性贡献时，其表达可受保护",
            })}
          </p>
          <p>
            {T({
              ...
              ja: "米著作権局: AI部分は非保護、人の選択・配列・編集のみ保護",
              zh: "美国版权局: AI 生成部分不受保护，仅人类选择、编排、编辑受保护",
            })}
          </p>
          <p>
            {T({
              ...
              ja: "Loreguard は AI 使用比率を追跡せず、著作権判断は各国法に基づき利用者が行う",
              zh: "Loreguard 不追踪用户 AI 使用比例，著作权判断由用户依当地法律自行决定",
            })}
          </p>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          {T({
            ...
            ja: "Network等の公開領域で侵害を発見した場合、下記項目をメール送信",
            zh: "若在 Loreguard 公开区域(如 Network 社区)发现侵权内容，请邮件提交下列信息",
          })}
        </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">
          {T({
            ...
            ja: "Loreguard の DGX モデルは利用者作品を再学習しない",
            zh: "Loreguard 自有 DGX 模型不将用户作品用于再训练",
          })}
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">
          {T({
            ...
            ja: "翻訳スタジオは自作または許諾を得た作品のみ使用可",
            zh: "翻译工作室仅限自己作品或已获授权的作品",
          })}
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">
          {T({
            ...
            ja: "外部プラットフォーム投稿時の各社規約遵守は利用者責任",
            zh: "将作品上传至外部平台时，遵守各平台规则(独家条款、AI 告知、等级等)由用户负责",
          })}
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">
          {T({
            ...
            ja: "Amazon KDP 等は AI 使用比率公開義務化",
            zh: "部分平台(如 Amazon KDP)要求公开 AI 使用比例",
          })}
        </p>
      </section>
    </LegalPageLayout>
