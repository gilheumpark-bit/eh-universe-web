  ...
  return (
    ...
    >
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-5 space-y-2 text-text-secondary text-sm leading-relaxed">
          <li>{T({ ko: "Loreguard는 Qwen 3.5-9B(DGX 로컬), Gemini, Claude, OpenAI, Groq 등 다수의 AI 모델을 사용합니다. 모델별 상세는 /ai-disclosure 참조.", en: "Loreguard uses multiple AI models including Qwen 3.5-9B (DGX local), Gemini, Claude, OpenAI, and Groq. See /ai-disclosure for details.", ja: "Loreguardは Qwen 3.5-9B(DGXローカル)、Gemini、Claude、OpenAI、Groq 等を使用します。詳細は /ai-disclosure。/ See /ai-disclosure for model details.", zh: "Loreguard 使用包括 Qwen 3.5-9B(DGX 本地)、Gemini、Claude、OpenAI、Groq 在内的多种 AI 模型。详情见 /ai-disclosure。/ See /ai-disclosure for model details." })}</li>
