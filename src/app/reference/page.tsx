    ...
    <>
      ...
      <main className="pt-24">
        <div className="site-shell py-16 md:py-20">
          ...
          <div className="premium-panel rounded-b-3xl rounded-t-none border-t-0 p-6 sm:p-10">
            ...
            <section className="mb-16">
              <h2 className="font-mono text-lg font-bold text-accent-purple tracking-wider uppercase mb-6">
              ...
              <div className="space-y-4 text-text-secondary leading-relaxed">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-3">
                  <div className="zone-card zone-red">
                    <h4 className="font-mono text-xs font-bold text-accent-red">TYPE A</h4>
                  ...
                  <div className="zone-card zone-amber">
                    <h4 className="font-mono text-xs font-bold text-accent-amber">TYPE B</h4>
                  ...
                  <div className="zone-card zone-blue">
                    <h4 className="font-mono text-xs font-bold text-accent-blue">TYPE C</h4>
              ...
              <div className="space-y-3">
                {(en
                  ...
                  <div key={item.type} className="premium-panel-soft flex items-center gap-4 rounded-[20px] p-4">
                    <span className="font-mono text-xs font-bold text-accent-purple w-16">{item.type}</span>
                    <span className="font-semibold text-text-primary text-sm w-20">{item.name}</span>
                    <span className="font-mono text-xs text-accent-amber w-10">{item.pct}</span>
                ...
                {(en
                  ...
                  <div key={g.name} className="premium-link-card card-glow p-5">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-mono text-sm font-bold text-text-primary">{g.name}</span>
                      <span className="badge badge-classified">{g.title}</span>
                    </div>
                    <p className="font-mono text-xs text-accent-purple mb-1">{g.role}</p>
