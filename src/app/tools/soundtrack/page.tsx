...
const TRACKS: Track[] = [
  ...
  },
  {
    ...
    desc: {
      ko: "SJC v47이 판정을 내리는 순간. 45,000 Hart의 EH가 측정된다. 신민아의 하수도 탈출이 기준점이 된 그 수치. 시스템이 정의할 수 없는 인간 선택의 잔여 가능성.",
      en: "The moment SJC v47 renders judgment. 45,000 Hart of EH measured. The benchmark set by Shin Min-ah's sewer escape. The residual possibility of human choice that systems cannot define.",
    },
    theme: "#1b2d4e",
  ...
  },
  {
    ...
    subtitle: { ko: "비밀조사국 — 기밀 문서의 기록", en: "Bureau of Investigation — Classified Records" },
    desc: {
      ko: "무단 유출 시 해당 인원은 오타로 처리된다. 66,000,000년의 타임라인. 200개 이상의 아티클. 4개 장르가 하나의 우주에 수렴하는 기록의 무게.",
      en: "Unauthorized disclosure will result in the personnel being processed as a typo. 66,000,000 years of timeline. 200+ articles. The weight of records where 4 genres converge into one universe.",
    },
    theme: "#2e2418",
