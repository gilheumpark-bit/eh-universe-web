/**
 * creative-domain-prompts/types.ts (2026-05-10 신설 — I-06 수리)
 *
 * 창작 구조화 생성기 (캐릭터·아이템·스킬·마법·세계관 등) 의
 ...
 *
 * [C] 안전성: 도메인 enum + Record<CreativeDomain> 강제
 * [G] 성능: O(1) 도메인 lookup
...
const APP_LANG_TO_DOMAIN: Record<AppLanguage, CreativeDomain> = {
  KO: 'korean-webnovel',
  EN: 'western-fantasy',
...
/** AppLanguage → 기본 CreativeDomain. 향후 사용자 override 가능. */
export function defaultDomainFor(lang: AppLanguage): CreativeDomain {
 ...
 */
export interface CreativeDomainPrompts {
