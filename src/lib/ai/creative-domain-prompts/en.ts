/**
 * creative-domain-prompts/en.ts — Western fantasy/epic creative domain.
 *
 ...
 * [K] Implements the same 7-builder CreativeDomainPrompts interface
 */
...
export const EN_FANTASY: CreativeDomainPrompts = {
