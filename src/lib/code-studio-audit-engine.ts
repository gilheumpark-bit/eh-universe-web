...
import { CATEGORY_WEIGHTS, AREA_TO_CATEGORY } from './code-studio-audit-types';

import { auditOperations, auditComplexity, auditArchitecture, auditDependencies } from './code-studio-audit-code-health';
import { auditTesting, auditErrorHandling, auditFeatureCompleteness, auditDocumentation } from './code-studio-audit-quality';
import { auditDesignSystem, auditAccessibility, auditUXQuality, auditI18n } from './code-studio-audit-ux';
import { auditSecurity, auditPerformance, auditAPIHealth, auditEnvConfig } from './code-studio-audit-infra';
...
// IDENTITY_SEAL: PART-3 | role=urgent-extraction | inputs=AuditAreaResult[] | outputs=AuditUrgentItem[]
...
export function runProjectAudit(
  ...
  function progress(area: string): void {
