...
export const BOARD_TYPE_LABELS: Record<BoardType, LabelPair> = {
  notice: { ko: "중앙 공문", en: "Central Notice" },
  registry: { ko: "행성 등록소", en: "Planet Registry" },
  log: { ko: "관측 로그", en: "Observation Log" },
  settlement: { ko: "정산 결과", en: "Settlement Result" },
  if: { ko: "IF 구역", en: "IF Zone" },
  feedback: { ko: "피드백 / 협업", en: "Feedback / Collaboration" },
};

export const REPORT_TYPE_LABELS: Record<ReportType, LabelPair> = {
  manual: { ko: "운용교범", en: "Operations Manual" },
  guide: { ko: "공식해설", en: "Official Guide" },
  technical: { ko: "기술보고", en: "Technical Report" },
  settlement: { ko: "정산보고", en: "Settlement Report" },
  observation: { ko: "관측보고", en: "Observation Report" },
  incident: { ko: "사건기록", en: "Incident Record" },
  testimony: { ko: "증언기록", en: "Testimony Record" },
  recovered: { ko: "회수문서", en: "Recovered Document" },
};

export const PLANET_GOAL_LABELS: Record<PlanetGoal, LabelPair> = {
  maintain: { ko: "유지", en: "Maintain" },
  develop: { ko: "발전", en: "Develop" },
  collapse: { ko: "붕괴", en: "Collapse" },
...
export const PLANET_STATUS_LABELS: Record<PlanetStatus, LabelPair> = {
  ...
  collapse: { ko: "붕괴", en: "Collapse" },
  experiment: { ko: "실험", en: "Experiment" },
  freeze: { ko: "동결", en: "Freeze" },
  discard: { ko: "폐기", en: "Discard" },
};

export const OFFICIALITY_LABELS: Record<Officiality, LabelPair> = {
  official: { ko: "공식", en: "Official" },
  unofficial: { ko: "비공식", en: "Unofficial" },
  fan: { ko: "팬기록", en: "Fan Record" },
  experimental: { ko: "실험기록", en: "Experimental Record" },
  pending: { ko: "검토중", en: "Pending Review" },
};

export const VISIBILITY_LABELS: Record<Visibility, LabelPair> = {
  public: { ko: "공개", en: "Public" },
  members: { ko: "회원 공개", en: "Members" },
