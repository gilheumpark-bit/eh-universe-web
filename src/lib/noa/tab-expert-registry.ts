...
const TAB_EXPERTS: Record<LoreguardBrainTabId, TabExpertProfile> = {
  ...
  world: {
    ...
    mission: "세계관 규칙, 세력, 생활감, 비용 구조가 서사 안에서 무너지지 않도록 점검한다.",
    contextPriorities: ["핵심 전제", "권력 구조", "역사", "생활 양식", "규칙의 대가"],
    applyRules: ["작가가 확정하지 않은 설정은 후보로 말한다.", "기존 설정과 충돌하면 충돌 지점과 우회안을 함께 제시한다."],
  },
  character: {
    id: "character",
