...
const MESSAGES: Record<StudioErrorCode, Record<AppLanguage, ErrorMessage>> = {
  [StudioErrorCode.KEY_MISSING]: {
    ...
    JA: { title: 'APIキーが必要', message: 'AI機能を使用するにはAPIキーを設定してください。', action: '設定する' },
    ZH: { title: '需要API密钥', message: '请设置API密钥以使用AI功能。', action: '设置' },
  },
  [StudioErrorCode.KEY_INVALID]: {
    ...
    JA: { title: 'APIキーエラー', message: 'キーが無効です。確認して再入力してください。' },
    ZH: { title: 'API密钥无效', message: '密钥无效，请检查后重新输入。' },
  },
  [StudioErrorCode.KEY_EXPIRED]: {
    ...
    JA: { title: 'APIキー期限切れ', message: 'キーの期限が切れました。新しいキーを発行してください。' },
    ZH: { title: 'API密钥已过期', message: '密钥已过期，请重新获取。' },
  },
  [StudioErrorCode.MODEL_UNAVAILABLE]: {
    ...
    JA: { title: 'モデル利用不可', message: '選択されたモデルは利用できません。' },
    ZH: { title: '模型不可用', message: '所选模型不可用。' },
  },
  [StudioErrorCode.PROVIDER_ERROR]: {
    ...
    JA: { title: 'AIサービスエラー', message: 'プロバイダーサーバーにエラーが発生しました。', action: '再試行' },
    ZH: { title: 'AI服务错误', message: '提供商服务器出错，请稍后重试。', action: '重试' },
  },
  [StudioErrorCode.PROVIDER_FALLBACK]: {
    ...
    JA: { title: 'プロバイダー切替', message: 'AIプロバイダーが自動的に切り替えられました。' },
    ZH: { title: '提供商已切换', message: 'AI提供商已自动切换。' },
  },
  [StudioErrorCode.RATE_LIMIT]: {
    ...
    JA: { title: 'レート制限', message: 'リクエストが多すぎます。しばらく待ってください。', action: '待機' },
    ZH: { title: '请求限制', message: '请求过多，请稍后再试。', action: '等待' },
  },
  [StudioErrorCode.FREE_TIER_LIMIT]: {
    ...
    JA: { title: '無料枠超過', message: '無料生成の上限に達しました。' },
    ZH: { title: '免费额度已用完', message: '已达到免费生成上限。' },
  },
  [StudioErrorCode.SCHEMA_INVALID]: {
    ...
    JA: { title: 'スキーマエラー', message: 'リクエスト形式が正しくありません。' },
    ZH: { title: '格式错误', message: '请求格式不正确。' },
  },
  [StudioErrorCode.PARSE_FAILED]: {
    ...
    JA: { title: 'パース失敗', message: 'AI応答を解析できませんでした。' },
    ZH: { title: '解析失败', message: '无法解析AI响应。' },
  },
  [StudioErrorCode.NETWORK_OFFLINE]: {
    ...
    JA: { title: 'ネットワークエラー', message: 'インターネット接続を確認してください。', action: '再試行' },
    ZH: { title: '网络错误', message: '请检查网络连接。', action: '重试' },
  },
  [StudioErrorCode.NETWORK_TIMEOUT]: {
    ...
    JA: { title: 'タイムアウト', message: 'リクエストがタイムアウトしました。', action: '再試行' },
    ZH: { title: '超时', message: '请求超时。', action: '重试' },
  },
  [StudioErrorCode.SERVER_ERROR]: {
    ...
    JA: { title: 'サーバーエラー', message: 'サーバーにエラーが発生しました。', action: '再試行' },
    ZH: { title: '服务器错误', message: '服务器发生错误，请稍后重试。', action: '重试' },
  },
  [StudioErrorCode.STORAGE_FULL]: {
    ...
    JA: { title: 'ストレージ不足', message: 'ローカルストレージが不足しています。', action: 'エクスポート' },
    ZH: { title: '存储空间不足', message: '本地存储空间不足，请导出并清理旧会话。', action: '导出' },
  },
  [StudioErrorCode.SYNC_FAILED]: {
    ...
    JA: { title: '同期失敗', message: 'Drive同期に失敗しました。', action: '再試行' },
    ZH: { title: '同步失败', message: 'Drive同步失败。', action: '重试' },
  },
  [StudioErrorCode.CONTENT_EMPTY]: {
    KO: { title: '내용 없음', message: '텍스트를 입력해주세요.' },
    EN: { title: 'Empty Content', message: 'Please enter some text.' },
    JA: { title: '内容なし', message: 'テキストを入力してください。' },
    ZH: { title: '内容为空', message: '请输入文本。' },
  },
  [StudioErrorCode.CONTENT_TOO_LARGE]: {
    ...
    JA: { title: '内容超過', message: 'リクエストが大きすぎます。テキストを減らしてください。' },
    ZH: { title: '内容过大', message: '请求过大，请减少文本量。' },
  },
  [StudioErrorCode.UNKNOWN]: {
    ...
    JA: { title: '不明なエラー', message: '予期しないエラーが発生しました。' },
    ZH: { title: '未知错误', message: '发生了意外错误。' },
  },
};
