...
export default {
  "galaxy-zones": {
    "title": {
      "ko": "은하 구역 분류",
      "en": "Galactic Zone Classification"
    },
    "level": "PUBLIC",
    "category": "GEOGRAPHY",
    "related": [
  ...
  "galaxy-profiles": {
    "title": {
      "ko": "양쪽 은하 프로필",
      "en": "Galaxy Profiles — Human vs Neka"
    },
    "level": "RESTRICTED",
    "category": "GEOGRAPHY",
    "related": [
  ...
  "visual-gate-infrastructure": {
    "title": {
      "ko": "Gate 인프라 도해",
      "en": "Gate Infrastructure Visual Reference"
    },
    "level": "CLASSIFIED",
    "category": "GEOGRAPHY",
  ...
  "rpt-galaxy-threat-assessment": {
    "title": {
      "ko": "은하 6개 구역 위협도 평가서",
      "en": "Galaxy 6-Zone Threat Assessment"
    },
    "level": "RESTRICTED",
    "category": "GEOGRAPHY",
    "content": {
  ...
  "rpt-finis-planet-recon": {
    "title": {
      "ko": "Finis 행성 정찰 보고 #FINIS-001",
      "en": "Finis Planet Reconnaissance Report #FINIS-001"
    },
    "level": "CLASSIFIED",
    "category": "GEOGRAPHY",
    "content": {
