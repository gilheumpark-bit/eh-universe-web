...
const baseProps: React.ComponentProps<typeof StudioSidebar> = {
  ...
  activeTab: 'writing',
  handleTabChange: noop as (tab: string) => void,
  studioMode: 'guided',
  ...
  handleImportTextFiles: noop as (e: React.ChangeEvent<HTMLInputElement>) => void,
  ...
  syncStatus: 'idle',
  lastSyncTime: null,
  showConfirm: noop as (opts: { title: string; message: string; variant?: string; onConfirm: () => void }) => void,
  closeConfirm: noop,
};
