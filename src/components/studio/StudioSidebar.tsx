  ...
  return (
    ...
    >
      <div className="flex h-dvh flex-col py-3 pl-3 pr-2 overflow-hidden">
        <div className="flex min-h-0 flex-1 flex-col overflow-y-auto rounded-[24px] bg-[#0A0A0C]/80 backdrop-blur-[32px] border border-white/[0.06] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.02),0_20px_40px_-10px_rgba(0,0,0,0.8)]">
