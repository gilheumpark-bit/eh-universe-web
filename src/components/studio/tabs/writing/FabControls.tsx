...
// ============================================================
// PART 1: FabControls: 노아 제안 FAB + Ctrl+Enter + slow warning listener
// ============================================================
//
// 역할:
//   - 노아 모드 전용 플로팅 "노아 제안" 버튼 (Ctrl+Enter 단축키)
//   - 글로벌 Ctrl+Enter 키 바인딩 (노아 모드에서만 활성)
//   - 느린 생성 경고 구독 (noa:generation-slow / noa:generation-very-slow)
//   - 씬시트 빈 상태 가드 — 클릭 시 토스트 + 노아 제안 차단 (작가 주도)
//
// M2.2 Day 11-12: 작가 주도 철학 반영.
//   - 레이블: "NOA 생성"에서 "노아 제안"으로 변경 (작가가 쓰고 노아가 받침)
//   - 시각 강도: primary full 에서 secondary outline + hover 강조
//   - sceneSheetEmpty 연결: prop 만 받던 구조에서 실제 가드 + toast
...
function FabControlsImpl(props: FabControlsProps): React.ReactElement | null {
  ...
  const warnTitle = sceneSheetEmpty
    ? L4(language, {
        ko: '씬시트를 먼저 채우면 노아 제안이 더 정확해집니다 (Ctrl+Enter)',
    ...
    : L4(language, {
        ko: '노아 제안 (Ctrl+Enter) — 작가가 먼저, 노아가 받침',
