    ...
    <div className="mx-auto max-w-5xl px-4 py-8 space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[rgba(92,143,214,0.3)] bg-[linear-gradient(135deg,rgba(92,143,214,0.15),rgba(45,39,83,0.1))] text-[rgba(163,196,255,0.9)] shadow-[0_0_20px_rgba(92,143,214,0.15)]">
            <Languages className="h-6 w-6" />
          </div>
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-[rgba(92,143,214,0.7)]">
                Nexus Bridge
              </span>
              <span className="flex h-1.5 w-1.5 items-center justify-center">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[rgba(92,143,214,0.6)] opacity-75"></span>
                <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-[rgba(92,143,214,0.9)]"></span>
              </span>
            </div>
        ...
        <button
          ...
          className={`group flex items-center gap-2 rounded-xl border px-4 py-2 font-mono text-[11px] font-semibold uppercase tracking-wider transition-all duration-300 ${
            showAdvanced 
              ? 'border-[rgba(92,143,214,0.4)] bg-[rgba(92,143,214,0.1)] text-[rgba(180,210,255,0.95)] shadow-[0_0_15px_rgba(92,143,214,0.1)]' 
              : 'border-white/8 bg-black/20 text-text-tertiary hover:border-[rgba(92,143,214,0.2)] hover:bg-[rgba(92,143,214,0.05)] hover:text-text-secondary'
          }`}
        >
          ...
          return (
            <button
              ...
              className={`relative overflow-hidden rounded-[1.25rem] border p-5 text-left transition-all duration-300 ${
                isSelected
                  ? "border-[rgba(92,143,214,0.4)] bg-[linear-gradient(145deg,rgba(92,143,214,0.12),rgba(0,0,0,0.6))] shadow-[0_8px_32px_rgba(92,143,214,0.1)] translate-y-[-2px]"
                  : "border-white/8 bg-white/2 hover:border-white/15 hover:bg-white/4"
              }`}
            >
              {isSelected && (
                <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_top_right,rgba(92,143,214,0.2),transparent_70%)]" />
              )}
              <div className="relative z-10 flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <span className={`flex h-2 w-2 rounded-full ${isSelected ? 'bg-[rgba(92,143,214,0.9)] shadow-[0_0_8px_rgba(92,143,214,0.8)]' : 'bg-white/20'}`} />
      ...
      <div className="relative flex flex-col md:flex-row items-center gap-6 rounded-[1.25rem] border border-white/8 bg-black/40 backdrop-blur-xl p-5 shadow-2xl before:absolute before:inset-0 before:bg-[linear-gradient(to_bottom,rgba(255,255,255,0.03),transparent)] before:pointer-events-none before:rounded-[1.25rem]">
        ...
        <div className="space-y-2.5 w-full md:w-auto md:min-w-[160px] relative z-10">
          <label className="flex items-center gap-2 font-mono text-[10px] font-semibold uppercase tracking-[0.15em] text-text-tertiary">
            <div className="w-1.5 h-1.5 rounded-full bg-[rgba(92,143,214,0.5)]"></div>
            ...
            {(["EN", "JP", "CN"] as TranslationTarget[]).map((l) => (
              <button
                ...
                className={`flex-1 rounded-lg px-3 py-2 font-mono text-[12px] font-bold tracking-wider transition-all duration-200 ${
                  targetLang === l
                    ? "bg-[rgba(92,143,214,0.15)] text-[rgba(180,210,255,0.95)] shadow-[inset_0_0_0_1px_rgba(92,143,214,0.3),0_0_10px_rgba(92,143,214,0.1)]"
        ...
        <div className="flex-1 w-full space-y-3 relative z-10">
          <div className="flex items-center justify-between">
            ...
            <div className="font-mono text-[10px] px-2.5 py-1 rounded-md bg-[rgba(92,143,214,0.1)] border border-[rgba(92,143,214,0.2)] text-[rgba(180,210,255,0.95)] flex items-center gap-2 shadow-[0_0_10px_rgba(92,143,214,0.05)]">
              <span className="font-bold tracking-widest">{bandLbl}</span>
              <span className="text-[rgba(92,143,214,0.6)]">|</span>
          ...
          <div className="relative pt-1">
            <input
              ...
              className="w-full h-1.5 bg-black/60 rounded-full appearance-none outline-none accent-[rgba(92,143,214,0.9)] cursor-pointer"
            />
            {/* Custom slider track overlay for premium feel */}
            <div 
              className="absolute top-1 left-0 h-1.5 bg-[linear-gradient(90deg,rgba(92,143,214,0.4),rgba(92,143,214,0.9))] rounded-full pointer-events-none"
              style={{ width: `${((band - BAND_META.min) / (BAND_META.max - BAND_META.min)) * 100}%` }}
            >
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-4 bg-white rounded-full shadow-[0_0_10px_rgba(92,143,214,0.8)] border-2 border-[rgba(92,143,214,1)]"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      {showAdvanced && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 p-5 rounded-[1.25rem] border border-[rgba(92,143,214,0.2)] bg-[linear-gradient(to_bottom_right,rgba(92,143,214,0.05),rgba(0,0,0,0.5))] shadow-[inset_0_0_20px_rgba(92,143,214,0.02)] animate-in slide-in-from-top-2 duration-300">
          <div className="space-y-2">
            <label className="flex items-center gap-1.5 font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-[rgba(92,143,214,0.7)]">
            ...
            <select
              ...
              className="w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2.5 font-mono text-[11px] text-[rgba(220,235,255,0.9)] outline-none focus:border-[rgba(92,143,214,0.5)] focus:ring-1 focus:ring-[rgba(92,143,214,0.3)] transition-all"
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2.5 font-mono text-[11px] disabled:opacity-30 disabled:cursor-not-allowed text-[rgba(220,235,255,0.9)] outline-none focus:border-[rgba(92,143,214,0.5)] focus:ring-1 focus:ring-[rgba(92,143,214,0.3)] transition-all"
            >
      ...
      <div className="flex flex-col sm:flex-row items-end gap-4 p-5 rounded-[1.25rem] border border-white/8 bg-black/20 backdrop-blur-md">
        <div className="flex-1 w-full space-y-2">
          <label className="flex items-center gap-2 font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-text-tertiary">
            <FileText className="h-3 w-3 text-[rgba(92,143,214,0.7)]" />
          ...
          <div className="relative group">
            <select
              ...
              className="w-full appearance-none rounded-xl border border-white/10 bg-black/50 px-4 py-3.5 pr-10 font-mono text-[13px] text-text-primary outline-none focus:border-[rgba(92,143,214,0.4)] group-hover:border-white/20 transition-all shadow-inner"
            >
            ...
            <ChevronDown className="pointer-events-none absolute right-4 top-1/2 h-4 w-4 -translate-y-1/2 text-[rgba(92,143,214,0.5)] group-hover:text-[rgba(92,143,214,0.9)] transition-colors" />
          </div>
        </div>
        ...
        {isTranslating ? (
          ...
          <button
            ...
            className="w-full sm:w-[220px] h-[52px] flex items-center justify-center gap-3 rounded-xl bg-[linear-gradient(45deg,rgba(45,100,200,0.6),rgba(92,143,214,0.9))] border border-[rgba(163,196,255,0.4)] px-6 font-mono text-[12px] font-black uppercase tracking-widest text-white transition-all hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(92,143,214,0.4)] disabled:opacity-40 disabled:hover:scale-100 disabled:hover:shadow-none shadow-[0_5px_20px_rgba(92,143,214,0.2)]"
          >
      ...
      {(progress.status !== "idle" || logs.length > 0) && (
        <div className="rounded-[1.25rem] border border-[rgba(92,143,214,0.2)] bg-[#030610] overflow-hidden flex flex-col h-[320px] shadow-[0_10px_40px_rgba(0,0,0,0.5),inset_0_0_20px_rgba(92,143,214,0.03)] relative">
          {/* Terminal Scanline overlay */}
          <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(rgba(92,143,214,0.02)_50%,transparent_50%)] bg-size-[100%_4px] z-10" />
          
          {/* Terminal Header */}
          <div className="flex items-center justify-between px-5 py-3 border-b border-[rgba(92,143,214,0.15)] bg-[rgba(92,143,214,0.05)] relative z-20">
            <div className={`flex items-center gap-3 font-mono text-[11px] font-bold uppercase tracking-[0.2em] ${progress.status === 'idle' ? 'text-[rgba(92,143,214,0.5)]' : 'text-[rgba(163,196,255,0.9)]'}`}>
              {(progress.status === "translating" || progress.status === "scoring") && <Loader2 className="h-3 w-3 animate-spin text-[rgba(92,143,214,0.8)]" />}
            ...
            <div className="flex items-center gap-4">
              <span className="font-mono text-[10px] font-bold tracking-widest text-[rgba(92,143,214,0.6)]">
              ...
              <div className="w-32 h-1.5 bg-black/60 rounded-full overflow-hidden border border-white/5 relative">
                <div
                  className="absolute inset-y-0 left-0 bg-[rgba(92,143,214,0.9)] shadow-[0_0_10px_rgba(92,143,214,0.8)] transition-all duration-300"
          ...
          {/* Terminal Output */}
          <div className="flex-1 overflow-y-auto p-5 font-mono text-[11px] relative z-20 custom-scrollbar-blue">
            <div className="space-y-3">
              {logs.map(log => (
                <div key={log.id} className="flex gap-4 items-start group">
                  <span className="text-[rgba(92,143,214,0.4)] shrink-0 font-bold group-hover:text-[rgba(92,143,214,0.6)] transition-colors">[{new Date(log.id).toISOString().substring(11, 23)}]</span>
                  <span className={`shrink-0 w-12 text-center uppercase text-[9px] font-black tracking-widest py-0.5 rounded-sm border ${
                    ...
                    'text-[rgba(163,196,255,0.9)] border-[rgba(92,143,214,0.3)] bg-[rgba(92,143,214,0.1)]'
                  }`}>SYS</span>
                  <div className="flex-1 min-w-0 flex flex-col gap-1.5">
                    ...
                    {log.detail && (
                      <div className="relative pl-3 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px before:bg-[linear-gradient(to_bottom,rgba(92,143,214,0.4),transparent)]">
                        <div className="text-[rgba(163,196,255,0.6)] text-[10px] leading-relaxed font-sans line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                          {log.detail}
                        </div>
                      </div>
                    )}
              ...
              {progress.status !== 'idle' && progress.status !== 'done' && (
                <div className="flex gap-4 animate-pulse">
                  <span className="text-[rgba(92,143,214,0.4)] shrink-0 font-bold">[{new Date().toISOString().substring(11, 23)}]</span>
                  <span className="w-2 h-3 bg-[rgba(92,143,214,0.7)] mt-0.5" />
                </div>
              )}
            </div>
          ...
          <style jsx>{`
            ...
            .custom-scrollbar-blue::-webkit-scrollbar-thumb { background: rgba(92,143,214,0.2); border-radius: 10px; }
            .custom-scrollbar-blue::-webkit-scrollbar-thumb:hover { background: rgba(92,143,214,0.4); }
          `}</style>
        </div>
      )}
      ...
      {translatedList.length > 0 && (
        <div className="pt-6 border-t border-[rgba(92,143,214,0.15)] space-y-4">
          <div className="flex items-center gap-3 text-[rgba(163,196,255,0.8)]">
            <FileText className="h-5 w-5" />
            <h3 className="font-mono text-[13px] font-bold uppercase tracking-[0.2em]">
              {isKO ? "현지화 완료 데이터베이스" : "Localized Database"} <span className="text-[rgba(92,143,214,0.5)]">({translatedList.length})</span>
            </h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {translatedList.map((t, i) => (
               <div key={i} className="group relative flex flex-col gap-2.5 rounded-2xl border border-[rgba(92,143,214,0.15)] bg-black/40 backdrop-blur-md p-4 transition-all duration-300 hover:border-[rgba(92,143,214,0.4)] hover:bg-[rgba(92,143,214,0.05)] hover:-translate-y-1 shadow-lg hover:shadow-[0_10px_30px_rgba(92,143,214,0.1)]">
                <div className="absolute top-0 left-4 right-4 h-px bg-[linear-gradient(90deg,transparent,rgba(92,143,214,0.3),transparent)] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="flex items-center gap-3">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[rgba(92,143,214,0.1)] text-[rgba(163,196,255,0.9)]">
                ...
                <div className="flex items-center gap-2 font-mono text-[10px] text-[rgba(163,196,255,0.7)] ml-11">
                  <span className="bg-black/50 border border-white/10 px-2 py-1 rounded-[0.5rem] tracking-wider font-bold shadow-inner">
                    {t.sourceLang} <span className="text-[rgba(92,143,214,0.5)]">→</span> {t.targetLang}
                  </span>
      ...
      {manuscripts.length === 0 && (
        <div className="flex flex-col items-center justify-center rounded-[1.25rem] border border-dashed border-[rgba(92,143,214,0.3)] bg-black/20 backdrop-blur-md p-12 text-center shadow-[inset_0_0_50px_rgba(0,0,0,0.5)]">
          <Languages className="mb-4 h-10 w-10 text-[rgba(92,143,214,0.4)]" />
          <p className="font-mono text-[12px] tracking-widest text-[rgba(163,196,255,0.7)]">
