...
const SECTIONS: Record<AppLanguage, DocSection[]> = {
  ...
  JP: [
    ...
    { id: "local", title: "10. ローカルAI", content: "Ollama / LM Studio対応\nローカルGPU: Gemma 4 26B/4B, EXAONE 32B対応\n\n⚠️ Vercel環境ではローカルAI不可" },
