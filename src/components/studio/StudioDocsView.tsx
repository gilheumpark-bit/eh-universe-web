...
const SECTIONS: Record<AppLanguage, DocSection[]> = {
  ...
  JP: [
    ...
    { id: "manuscript", title: "8. 原稿管理", content: "チャプター分析: NOA自動抽出 (人物/背景/シーン/サウンド/画像プロンプト/音楽プロンプト)\nエクスポート6種: EPUB / DOCX / TXT / JSON / Backup / インポート\nセーブスロット: 設定の完全保存/復元" },
  ...
  CN: [
    ...
    { id: "manuscript", title: "8. 稿件管理", content: "章节分析: NOA自动提取 (人物/背景/场景/声音/图像提示/音乐提示)\n导出6种: EPUB / DOCX / TXT / JSON / Backup / 导入\n存档槽: 完整配置保存/恢复" },
