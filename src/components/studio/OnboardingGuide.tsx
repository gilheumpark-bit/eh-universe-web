...
const LABELS: Record<AppLanguage, {
  ...
  KO: {
    ...
    quickStart: "쾌속 시작",
    quickStartDesc: "장르와 한 줄 프롬프트만 입력하면 AI가 세계관·캐릭터·첫 장면을 자동 생성합니다.",
    manual: "직접 설정",
  ...
  EN: {
    ...
    quickStartDesc: "Enter a genre and one-line prompt. AI generates world, characters, and first scene.",
    manual: "Manual Setup",
  ...
  JP: {
    ...
    quickStart: "クイックスタート",
    quickStartDesc: "ジャンルとプロンプトを入力するだけ。AIが世界観・キャラ・冒頭を自動生成します。",
    manual: "手動設定",
  ...
  CN: {
    ...
    quickStart: "快速开始",
    quickStartDesc: "输入类型和一句提示，AI自动生成世界观、角色和开场。",
    manual: "手动设置",
