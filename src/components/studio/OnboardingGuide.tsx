...
const LABELS: Record<AppLanguage, {
  ...
  KO: {
    ...
    quickStart: "쾌속 시작",
    quickStartDesc: "장르와 한 줄 프롬프트만 입력하면 세계관·캐릭터·첫 장면 초안이 준비됩니다.",
    manual: "직접 설정",
  ...
  EN: {
    ...
    quickStartDesc: "Enter a genre and one-line prompt. World, characters, and first scene drafts are prepared.",
    manual: "Manual Setup",
    manualDesc: "Configure world, characters, and direction step by step.",
    demo: "Try Demo",
    demoDesc: "Open a pre-built story to explore all features.",
    byok: "Connection key required",
    skip: "Skip",
  },
  JP: {
    eyebrow: "LOREGUARD",
    ...
    quickStart: "クイックスタート",
    quickStartDesc: "ジャンルとプロンプトを入力するだけ。世界観・キャラ・冒頭の草稿が準備されます。",
    manual: "手動設定",
  ...
  CN: {
    ...
    quickStart: "快速开始",
    quickStartDesc: "输入类型和一句提示，世界观、角色和开场草稿会准备好。",
    manual: "手动设置",
