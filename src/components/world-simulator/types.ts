...
export const RULE_LEVELS: { lv: number; ko: string; en: string; desc_ko: string; desc_en: string; desc_ja: string; desc_zh: string; pct: number; genre_ko: string; genre_en: string; genre_ja: string; genre_zh: string; color: string }[] = [
  ...
  { lv: 8, ko: "디스토피아", en: "Dystopia", desc_ko: "풀 엔진 + 자격 박탈 + 세계 붕괴", desc_en: "Full engine + dequalification + system crash", desc_ja: "フルエンジン+資格剥奪+世界崩壊", desc_zh: "全引擎+资格剥夺+世界崩溃", pct: 90, genre_ko: "디스토피아/SF", genre_en: "Dystopia/SF", genre_ja: "ディストピア/SF", genre_zh: "反乌托邦/SF", color: "#991b1b" },
