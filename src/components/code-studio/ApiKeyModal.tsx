...
export function ApiKeyModal({ onSave, onSkip }: Props) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm" style={{ zIndex: 'var(--z-modal)' }} role="dialog" aria-modal="true" aria-label="EH Code Studio API 키 설정">
