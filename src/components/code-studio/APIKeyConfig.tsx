...
export function APIKeyConfig({ onClose }: Props) {
  ...
  const modalContent = (
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm" style={{ zIndex: 'var(--z-modal)' }} role="dialog" aria-modal="true" aria-label="API 키 슬롯 관리">
