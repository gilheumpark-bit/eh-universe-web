...
import type { AuditReport, AuditCategoryResult, AuditAreaResult, AuditSeverity } from '@/lib/code-studio-audit-types';
import { AUDIT_AREA_LABELS, CATEGORY_LABELS } from '@/lib/code-studio-audit-types';
