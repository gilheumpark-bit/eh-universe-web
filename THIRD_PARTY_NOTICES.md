...
> claude3 `_standard/_legal.md` · `_dependencies.md` 라이선스 준수. 본 제품은 비공개 상용 소프트웨어이며 다수 오픈소스 패키지를 사용한다.
...
2. CI에 license-checker `--onlyAllow` 게이트 추가(신규 강한 copyleft 유입 차단).
