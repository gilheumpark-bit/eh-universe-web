...
export default function StudioShell() {
  ...
  const { focusMode, setFocusMode, showShortcuts, setShowShortcuts, showSearch, setShowSearch, searchQuery, setSearchQuery } = useStudioTheme();
  ...
  return (
    ...
    >
      ...
      <StudioMainContent
        ...
        isSidebarOpen={false} setIsSidebarOpen={setIsSidebarOpen}
