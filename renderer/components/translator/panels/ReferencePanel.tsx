      ...
      <div className="p-4 shrink-0 border-b border-white/5">
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-black/40 border border-white/10 rounded-md py-1.5 pl-9 pr-3 text-[13px] text-text-primary placeholder:text-text-tertiary focus:outline-none focus:border-accent-amber/50 focus:ring-1 focus:ring-accent-amber/50 transition-all pointer-events-auto"
          />
        </div>
      </div>
