      ...
      <div className={`flex flex-col gap-2 max-w-[85%] ${isUser ? 'items-end' : 'items-start'}`}>
        ...
        <div className={`overflow-hidden transition-all ${
          ...
          {isUser ? (
            ...
            <div className={`prose ${isCompact ? 'prose-xs' : 'prose-sm sm:prose-base'} prose-invert max-w-none wrap-break-word prose-p:font-serif prose-p:text-text-secondary prose-p:leading-[1.8]`}>
