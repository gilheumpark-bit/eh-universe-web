                ...
                <div key={i} className="flex-1 relative h-full group">
                  ...
                  <div
                    className={`absolute bottom-0 w-full rounded-t-sm transition-all duration-300 ${
                      isCurrentEp ? 'bg-linear-to- from-blue-500 to-cyan-400' : 'bg-linear-to- from-blue-600/60 to-indigo-400/40'
                    }`}
                    style={{ height: `${height}%` }}
                  />
                  {isCurrentEp && (
        ...
        {report && (
          <div className="space-y-3">
            ...
            <div className="bg-bg-secondary/50 rounded-2xl p-4 border border-border/50 space-y-4">
              ...
              {/* AI Tone */}
              <div className="flex justify-between items-center">
                <span className="text-text-tertiary text-[9px]">AI Tone</span>
