  ...
  return (
    ...
    >
                ...
                return (
                  <button 
                    ...
                    className={`
                      ...
                      ${isActive 
                        ? 'text-accent-purple bg-accent-purple/15 shadow-lg shadow-accent-purple/20' 
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0 h-px bg-linear-to- from-transparent via-white/10 to-transparent" />
        ...
        {primaryTabs.map(({ key, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              {active && (
                <span 
                  className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 w-8 h-1 rounded-full bg-accent-purple shadow-md shadow-accent-purple/40"
