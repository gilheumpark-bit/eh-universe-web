    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col bg-bg-primary/95 backdrop-blur-xl border-t border-white/10 rounded-t-3xl shadow-[0_-12px_48px_rgba(0,0,0,0.5),0_-4px_16px_rgba(0,0,0,0.3)]">
          {/* Top highlight line */}
          <div className="absolute top-0 inset-x-0 h-px bg-linear-to- from-transparent via-white/20 to-transparent rounded-t-3xl" />
          ...
          >
            ...
            <div className={`
              ...
              ${dragging ? 'bg-accent-purple scale-110 shadow-lg shadow-accent-purple/30' : 'bg-white/25'}
            `} />
          ...
          <div className="relative flex-1 overflow-hidden">
            ...
            {/* Fade edge at bottom */}
            <div className="absolute bottom-0 inset-x-0 h-8 bg-linear-to- from-bg-primary/95 to-transparent pointer-events-none" />
          </div>
        </div>
      </div>
    </>
