  ...
  return (
    <div className={`flex flex-col items-center justify-center py-16 px-6 text-center ${className}`}>
      ...
      <div className={`relative mb-6 ${config.glow}`}>
        <div className={`
          w-24 h-24 rounded-3xl bg-linear-to- ${config.gradient}
      ...
      {(actionLabel || secondaryLabel) && (
        <div className="flex items-center gap-3 animate-in fade-in slide-in-from-bottom-2 duration-500 delay-200">
          {actionLabel && onAction && (
            <button
              onClick={onAction}
              className="px-5 py-2.5 bg-linear-to- from-accent-purple to-accent-purple/80 text-white text-sm font-bold rounded-xl hover:shadow-lg hover:shadow-accent-purple/20 hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
            >
...
export const EmptyStateCompact: React.FC<Omit<EmptyStateProps, 'secondaryLabel' | 'onSecondary'>> = ({
  ...
  return (
    <div className={`flex flex-col items-center justify-center py-8 px-4 text-center ${className}`}>
      <div className={`
        w-14 h-14 rounded-2xl bg-linear-to- ${config.gradient}
...
export const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  const gradients = {
    ...
    gradient: 'bg-linear-to- from-accent-purple via-accent-blue to-accent-green',
      ...
      className={`
        ...
        ${saved 
          ...
          : saving
            ...
            : 'bg-linear-to- from-accent-purple to-accent-purple/80 text-white hover:shadow-lg hover:shadow-accent-purple/20 hover:-translate-y-0.5 active:scale-95'
        }
        ${className}
      `}
    >
