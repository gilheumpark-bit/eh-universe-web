...
export function ShortcutsModal({ language, onClose }: { language: AppLanguage; onClose: () => void }) {
  ...
  return (
    ...
    >
      <div 
        className="relative bg-linear-to- from-bg-secondary/95 to-bg-primary/95 border border-white/[0.08] rounded-2xl p-6 max-w-lg w-full mx-4 shadow-[0_32px_64px_rgba(0,0,0,0.5)] animate-in zoom-in-95 slide-in-from-bottom-4 duration-300" 
