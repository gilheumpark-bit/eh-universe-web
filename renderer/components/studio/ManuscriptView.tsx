    ...
    <div className="max-w-6xl mx-auto py-4 px-3 sm:py-8 sm:px-4 md:py-12 md:px-6 space-y-4 sm:space-y-6">
      ...
      <div className="bg-bg-secondary border border-border rounded-xl p-4 space-y-3">
        ...
        <div className="w-full h-2 bg-bg-tertiary rounded-full overflow-hidden">
          <div
            className="h-full bg-linear-to- from-accent-purple to-accent-blue rounded-full transition-all duration-500"
                  ...
                  {editingEp === m.episode ? (
                    <div className="p-4 space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full min-h-[40vh] bg-bg-primary border border-border rounded-lg p-4 text-sm leading-loose font-serif outline-none focus:border-accent-purple resize-y"
                      />
                    ...
                    <div className="p-4">
                      ...
                      <div className="prose prose-sm max-w-none text-text-secondary font-serif leading-loose max-h-[60vh] sm:max-h-[50vh] overflow-y-auto overscroll-contain whitespace-pre-wrap text-sm sm:text-sm" style={{ WebkitOverflowScrolling: 'touch' }}>
                        {m.content}
                      </div>
