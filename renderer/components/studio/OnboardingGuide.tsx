          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {cards.map(({ key, icon, title, desc, accent, badge }, idx) => (
              ...
              className={`group relative flex flex-col items-center gap-4 rounded-2xl border p-6 text-center transition-all duration-300 hover:scale-[1.03] hover:-translate-y-1 active:scale-[0.98] animate-in fade-in slide-in-from-bottom-4 ${
                  accent
                    ? "border-accent-purple/40 bg-linear-to-b from-accent-purple/15 to-accent-purple/5 hover:border-accent-purple/60 hover:shadow-lg hover:shadow-accent-purple/20"
                    : "border-white/8 bg-linear-to-b from-white/4 to-transparent hover:border-white/15 hover:bg-white/6 hover:shadow-lg hover:shadow-black/30"
                }`}
              >
                {/* Icon Container */}
                <div className={`relative flex h-14 w-14 items-center justify-center rounded-2xl transition-all duration-300 ${
                  accent 
                    ? "bg-accent-purple/20 text-accent-purple group-hover:bg-accent-purple/30 group-hover:shadow-lg group-hover:shadow-accent-purple/30" 
