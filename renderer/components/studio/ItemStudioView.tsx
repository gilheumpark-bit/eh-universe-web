...
const ItemStudioView: React.FC<ItemStudioViewProps> = ({ language, config, setConfig }) => {
  ...
  // ============================================================
  return (
    <div className="relative max-w-[1400px] mx-auto px-4 py-6 space-y-6 min-h-full rounded-xl bg-[#030a0d] bg-[linear-gradient(rgba(16,185,129,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(16,185,129,0.03)_1px,transparent_1px)] bg-size-[40px_40px] shadow-[inset_0_0_0_1px_rgba(6,182,212,0.15)] before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_at_center,rgba(6,182,212,0.05)_0%,transparent_70%)] before:pointer-events-none box-border">
      {/* Header */}
                ...
                <div key={item.id} className={`${rCfg.bg} border border-emerald-500/30 backdrop-blur-md p-4 space-y-2 [clip-path:polygon(12px_0,100%_0,100%_calc(100%-12px),calc(100%-12px)_100%,0_100%,0_12px)] transition-all hover:shadow-[0_0_20px_rgba(6,182,212,0.15)]`}>
                  ...
                  <div className="space-y-1.5 pt-2 border-t border-border/50">
                    <input value={item.purpose ?? ''} onChange={e => updateItemField(item.id, 'purpose', e.target.value)}
                      placeholder={t('itemStudio.purposePlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] px-2.5 text-cyan-100 focus:border-cyan-400 focus:bg-cyan-900/20 focus:shadow-[0_0_10px_rgba(6,182,212,0.2)] py-1.5 text-[10px]" />
                    ...
                    {tierExpanded[item.id]?.t2 && (
                      <div className="space-y-1.5 pt-1.5">
                        <input value={item.worldConnection ?? ''} onChange={e => updateItemField(item.id, 'worldConnection', e.target.value)}
                          placeholder={t('itemStudio.worldConnectionPlaceholder')} className="w-full bg-emerald-950/40 border border-cyan-500/20 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-cyan-50 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.misuse ?? ''} onChange={e => updateItemField(item.id, 'misuse', e.target.value)}
                          placeholder={t('itemStudio.misusePlaceholder')} className="w-full bg-emerald-950/40 border border-cyan-500/20 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-cyan-50 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.lore ?? ''} onChange={e => updateItemField(item.id, 'lore', e.target.value)}
                          placeholder={t('itemStudio.lorePlaceholder')} className="w-full bg-emerald-950/40 border border-cyan-500/20 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-cyan-50 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.material ?? ''} onChange={e => updateItemField(item.id, 'material', e.target.value)}
                          placeholder={t('itemStudio.materialPlaceholder')} className="w-full bg-emerald-950/40 border border-cyan-500/20 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-cyan-50 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.craftMethod ?? ''} onChange={e => updateItemField(item.id, 'craftMethod', e.target.value)}
                          placeholder={t('itemStudio.craftMethodPlaceholder')} className="w-full bg-emerald-950/40 border border-cyan-500/20 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-cyan-50 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.valueRarity ?? ''} onChange={e => updateItemField(item.id, 'valueRarity', e.target.value)}
                          placeholder={t('itemStudio.valueRarityPlaceholder')} className="w-full bg-emerald-950/40 border border-cyan-500/20 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-cyan-50 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.whoTargets ?? ''} onChange={e => updateItemField(item.id, 'whoTargets', e.target.value)}
                          placeholder={t('itemStudio.whoTargetsPlaceholder')} className="w-full bg-emerald-950/40 border border-cyan-500/20 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-cyan-50 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                      </div>
                    )}
                  </div>
                  {/* 3단계 — 디테일 */}
                    ...
                    {tierExpanded[item.id]?.t3 && (
                      <div className="space-y-1.5 pt-1.5">
                        <input value={item.itemAppearance ?? ''} onChange={e => updateItemField(item.id, 'itemAppearance', e.target.value)}
                          placeholder={t('itemStudio.appearancePlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-emerald-100 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.symbolism ?? ''} onChange={e => updateItemField(item.id, 'symbolism', e.target.value)}
                          placeholder={t('itemStudio.symbolismPlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-emerald-100 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.currentLocation ?? ''} onChange={e => updateItemField(item.id, 'currentLocation', e.target.value)}
                          placeholder={t('itemStudio.currentLocationPlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-emerald-100 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.ownershipCond ?? ''} onChange={e => updateItemField(item.id, 'ownershipCond', e.target.value)}
                          placeholder={t('itemStudio.ownershipCondPlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-emerald-100 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.durability ?? ''} onChange={e => updateItemField(item.id, 'durability', e.target.value)}
                          placeholder={t('itemStudio.durabilityPlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-emerald-100 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.evolution ?? ''} onChange={e => updateItemField(item.id, 'evolution', e.target.value)}
                          placeholder={t('itemStudio.evolutionPlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-emerald-100 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                        <input value={item.maintenance ?? ''} onChange={e => updateItemField(item.id, 'maintenance', e.target.value)}
                          placeholder={t('itemStudio.maintenancePlaceholder')} className="w-full bg-emerald-950/40 border border-emerald-500/30 [clip-path:polygon(4px_0,100%_0,100%_calc(100%-4px),calc(100%-4px)_100%,0_100%,0_4px)] text-emerald-100 focus:border-cyan-400 focus:bg-cyan-900/20 px-2.5 py-1.5 text-[10px] outline-none" />
                      </div>
                    )}
                  </div>
                  {/* 한 줄 요약 */}
