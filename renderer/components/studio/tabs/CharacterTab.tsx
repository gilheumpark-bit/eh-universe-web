...
const CharacterTab: React.FC<CharacterTabProps> = ({
  ...
  const { activeSupportsStructured } = useAIProvider();
            ...
            <button 
              ...
              className={`group flex items-center gap-2.5 px-5 py-3 rounded-xl text-sm font-bold transition-all duration-200 ${
                charSubTab === 'characters' 
                  ? 'bg-accent-purple/15 text-accent-purple border border-accent-purple/30 shadow-md shadow-accent-purple/10'
            ...
            {charSubTab === 'characters' && (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-3 bg-linear-to-t from-accent-amber/80 to-accent-amber/50 text-bg-primary rounded-xl text-sm font-bold tracking-widest transition-all shadow-lg hover:shadow-accent-amber/20 hover:scale-[1.02] active:scale-95 disabled:opacity-50"
                >
            ...
            <button 
              ...
              className={`btn-ripple group flex items-center gap-2.5 px-6 py-3 rounded-xl text-sm font-bold uppercase tracking-wider transition-all duration-300 ${
                saveFlash 
                  ...
                  : 'bg-linear-to-t from-accent-purple to-accent-purple/80 text-white hover:shadow-lg hover:-translate-y-0.5 active:scale-95'
              }`}
            >
