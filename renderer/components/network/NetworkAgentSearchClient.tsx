          ...
          <div className="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-thin">
            ...
            {messages.map((msg) => (
              <div key={msg.id} className={`flex gap-4 ${msg.role === "agent" ? "flex-row" : "flex-row-reverse"}`}>
                <div className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center font-mono text-[10px] ${msg.role === "agent" ? "bg-accent-amber/20 text-accent-amber" : "bg-white/10 text-white"}`}>
            ...
            {isSearching && (
              <div className="flex gap-4">
                 <div className="shrink-0 w-8 h-8 rounded-full flex items-center justify-center font-mono text-[10px] bg-accent-amber/20 text-accent-amber">
                  AI
                </div>
